  ...
  <div class="classify">
    <header class="let_fixed">
      ...
      <van-tabs v-model="activeTab" @click="handleTabClick">
        <van-tab
          v-for="(item, index) in classicTabs"
    ...
    <section>
      ...
      <div v-if="!isloading && cardList.length <= 0" class="no_data">
        暂无数据
      </div>
...
<script>
  import itemCardMid2 from '@/components/item_card_tiny'
