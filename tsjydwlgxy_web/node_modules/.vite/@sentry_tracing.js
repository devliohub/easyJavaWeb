...
var MetricsInstrumentation = function() {
  function MetricsInstrumentation2() {
    ...
    if (!isNodeEnv() && ((_a = global2) === null || _a === void 0 ? void 0 : _a.performance)) {
...
var Integrations = __assign(__assign({}, integrations_exports), { BrowserTracing });
addExtensionMethods();
export {
  IdleTransaction,
  Integrations,
